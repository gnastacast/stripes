...
namespace DDG
{
   ...
   bool Viewer::showDirectionField = true;
   bool Viewer::animate = false;
   GLuint Viewer::texture = 0;
   bool Viewer::doPick = true;
   int Viewer::pickX = 0;
   int Viewer::pickY = 0;
   ...
   void Viewer :: initGLSL( void )
   {
      ...
      stripeShader.loadVertex( "shaders/stripeVertex.glsl" );
      stripeShader.loadFragment( "shaders/stripeFragment.glsl" );
   }
